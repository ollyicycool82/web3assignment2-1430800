...
if ( $_SERVER[ 'REQUEST_METHOD' ] == 'POST' )
{
  ...
  if ( empty( $errors ) )
  {
    ...
    if ( mysqli_num_rows( $r ) != 0 ) $errors[] = 'Email address already registered. <a href="authorlogin.php">Login</a>' ;
  }
  ...
  if ( empty( $errors ) ) 
  {
    ...
    $r = @mysqli_query ( $dbc, $q ) ;
    if ($r)
    { echo '<h1>Registered!</h1><p>You are now registered.</p><p><a href="authorlogin.php">AuthorLogin</a></p>'; }
