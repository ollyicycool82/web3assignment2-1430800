...
<header>
  <h1 align="center">Bookstop Register</h1>
    
  </header>
</head>
<title>Bookstop Register</title>
...
if ( $_SERVER[ 'REQUEST_METHOD' ] == 'POST' )
{
  ...
  if ( empty( $errors ) )
  {
    $q = "SELECT CustomerID FROM customer WHERE email='$e'" ;
  ...
  if ( empty( $errors ) ) 
  {
    $q = "INSERT INTO customer (FirstName, LastName, Email, pass1 ) VALUES ('$fn', '$ln', '$e', '$p' )";
    $r = @mysqli_query ( $dbc, $q ) ;
    if ($r)
...
<h1>Please Complete The Form To Register</h1>
<form action="register.php" method="post">
<p>First Name: <input type="text" name="FirstName" size="20" value="<?php if (isset($_POST['first_name'])) echo $_POST['first_name']; ?>"> 
Last Name: <input type="text" name="LastName" size="20" value="<?php if (isset($_POST['last_name'])) echo $_POST['last_name']; ?>"></p>
